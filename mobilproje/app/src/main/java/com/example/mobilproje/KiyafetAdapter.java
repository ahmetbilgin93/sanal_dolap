...
public class KiyafetAdapter extends RecyclerView.Adapter<KiyafetAdapter.MyViewHolder> {
    ...
    KiyafetAdapter.onItemClickListener listener;

    public KiyafetAdapter(Context context, ArrayList<KiyafetData> list) {
    ...
    public KiyafetAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.recv_kiyafet,parent,false);
        return new KiyafetAdapter.MyViewHolder(v);
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            kiyDel = itemView.findViewById(R.id.kiyDel);
            kiyEdit = itemView.findViewById(R.id.kiyEdit);

            kiyDel.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    int position = getAdapterPosition();
                    if (listener!=null && position !=RecyclerView.NO_POSITION)
                        listener.onDelClick(list.get(position));
                }
            });

            kiyEdit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    int position = getAdapterPosition();
                    if (listener!=null && position !=RecyclerView.NO_POSITION) {
                        listener.onEditClick(list.get(position));
                    }
                }
            });
    ...
    public interface onItemClickListener{
        void onDelClick(KiyafetData kiyafetData);
        void onEditClick(KiyafetData kiyafetData);
    }

...
public class Cek2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cek2);

        recyclerView = findViewById(R.id.recCekmece2);
        ...
        cekmeceAdapter.setOnItemClickListener(new CekmeceAdapter.onItemClickListener() {
            ...
            public void onItemClick(CekmeceData cekmeceData) {
                ...
                Intent intent=new Intent(Cek2Activity.this, Kiy2Activity.class);
